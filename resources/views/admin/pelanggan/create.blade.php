...
<form method="POST" action="{{url('admin/pelanggan/store')}}" class="m-5">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="kode" name="kode" placeholder="Input Kode Pelanggan" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">Nama</label> 
    <div class="col-8">
      <input id="nama" name="nama" placeholder="Input Nama Pelanggan" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
