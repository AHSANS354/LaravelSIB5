    ...
    <div class="col-xl-8 col-lg-7">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <hr>
                Harga Tertinggi Rp.{{ number_format(max($hitung_harga->pluck('harga_jual')->toArray())) }}
                <br>
                Harga Terendah Rp.{{ number_format(min($hitung_harga->pluck('harga_jual')->toArray())) }}
            </div>
        </div>
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                jumlah jenis kelamin {{$jk->jk}} : {{$jk->jumlah}} <br>
                @endforeach
            </div>
        </div>
    </div>
...
var label2 = [@foreach ($hitung_harga as $hitung) '{{$hitung->nama}}', @endforeach];
var data2 = [@foreach ($hitung_harga as $hitung) {{$hitung->harga_jual}}, @endforeach];
