...
@endif
<form method="POST" action="{{url('admin/produk/store')}}" enctype="multipart/form-data" class="m-5">
    @csrf
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="text1" name="harga_beli" type="text" class="form-control @error('harga_beli') is-invalid @enderror">
            @error('harga_beli')
            <div class="invalid-feedback">
                {{$message}}
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="text2" name="harga_jual" type="text" class="form-control @error('harga_jual') is-invalid @enderror">
            @error('harga_jual')
            <div class="invalid-feedback">
                {{$message}}
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="text3" name="stok" type="text" class="form-control @error('stok') is-invalid @enderror">
        </div>
    </div>
    <div class="form-group row">
